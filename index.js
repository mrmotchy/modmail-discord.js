    ...
    if (message.guild) {
        ...
        if (command == "mod-mail") {
            ...
            let embed = new discord.MessageEmbed()
                ...
                .addField("setup", "[Setup the modmail system](https://dsc.gg/dst74)", true)

                .addField("open", '[Let you open the mail to contact anyone with his ID](https://dsc.gg/dst74)', true)
                .setThumbnail(client.user.displayAvatarURL())
                .addField("close", "[Close the mail in the channel you are.](https://dsc.gg/dst74)", true);
